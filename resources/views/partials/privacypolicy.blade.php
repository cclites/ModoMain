<div class="privacypolicy">
	<ul>
		...
		<li>
			Site passwords are not stored in the any database
		</li>
		<li>
			Credentials for BitStamp are encrypted in the database.
		</li>
		<li>
			We reserve the right to monitor and record all site activity in order to maintain site stability and integrity.
		</li>
		<li>
			From time to time, ModoBot.com may send out emails to notify users of site issues or offers.
		</li>
		<li>
            Use of this site implies agreement to the following terms and conditions:
			<div class="policyContainer">
				...
				<div id='ppBody'>
					...
					<br />
					<div class='innerText'>
						When ordering or registering on our site, as appropriate, you may be asked to enter your email address, Alias or other details to help you with your experience.
					</div>
					<br>
					<div class='grayText'>
					...
					<div class='innerText'>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Google Display Network Impression Reporting
					</div>
					<br>
					<div class='innerText'>
					...
					<div class='innerText'>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Via Email
					</div>
					<div class='innerText'>
						Users are able to change their personal information:
					</div>
					<div class='innerText'>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> By logging in to their account
					</div>
					<div class='innerText'>
						<br>
					...
					<div class='innerText'>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Within 1 business day
					</div>
					<div class='innerText'>
						We will notify the users via in-site notification
					</div>
					<div class='innerText'>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Other
					</div>
					<div class='innerText'>
						As soon as breach occurs.
					</div>
					<div class='innerText'>
						<br>
					...
					<div class='innerText'>
						<strong>
						<br>
						If at any time you would like to unsubscribe from receiving future emails, you can email us at</strong>
					</div>
					<div class='innerText'>
